...
- **VPN:** Twingate (rocketskatesninja.twingate.com, manual toggle via bar widget — deliberately NOT auto-started, see `systemd.services.twingate.wantedBy = mkForce []` in configuration.nix)
